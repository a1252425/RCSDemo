...
#import "RCSChatsViewController.h"

@interface RCSHomeItemChatGroup () <RCSHomeItem>
...
- (void)performActionWithSender:(nullable id)sender {
    ...
    RCSChatsViewController *list = [[RCSChatsViewController alloc] initWithDisplayConversationTypes:@[@(ConversationType_GROUP)] collectionConversationType:@[]];
